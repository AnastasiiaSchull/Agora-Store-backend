...
namespace Agora.DAL.Migrations
{
    ...
    [Migration("20250818134448_addedNewFieldToPayment")]
    partial class addedNewFieldToPayment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Agora.DAL.Entities.AddressUser", b =>
                {
            ...
            modelBuilder.Entity("Agora.DAL.Entities.ProductWishlist", b =>
                {
                    b.Property<int>("ProductId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Agora.DAL.Entities.Payment", b =>
                {
                    ...
                    b.HasOne("Agora.DAL.Entities.GiftCard", "GiftCard")
                        .WithOne("Payment")
                        .HasForeignKey("Agora.DAL.Entities.Payment", "GiftCardId");
            ...
            modelBuilder.Entity("Agora.DAL.Entities.ProductWishlist", b =>
                {
                    ...
                    b.HasOne("Agora.DAL.Entities.Wishlist", "Wishlist")
                        .WithMany("ProductWishlists")
            ...
            modelBuilder.Entity("Agora.DAL.Entities.ReturnItem", b =>
                {
                    b.HasOne("Agora.DAL.Entities.OrderItem", "OrderItem")
                        .WithOne("ReturnItem")
                        .HasForeignKey("Agora.DAL.Entities.ReturnItem", "OrderItemId");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Agora.DAL.Entities.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
